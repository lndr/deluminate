...
project = 'deluminate'
copyright = "2019, Leander Claes"

# Get version number from git via setuptools_scm
release = get_distribution('deluminate').version
...
htmlhelp_basename = 'deluminatedoc'
...
latex_documents = [
    ('index', 'deluminate.tex',
     'deluminate Documentation',
     'Leander Claes', 'manual'),
]
